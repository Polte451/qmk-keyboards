...
#define HS_RGB_BLINK_INDEX_BT1              25 // KC_1
#define HS_RGB_BLINK_INDEX_BT2              26 // KC_2
#define HS_RGB_BLINK_INDEX_BT3              27 // KC_3
#define HS_RGB_BLINK_INDEX_2G4              28 // KC_4
#define HS_RGB_BLINK_INDEX_USB              29 // KC_5

/* Old Connetion RGB Indicators
#define HS_RGB_BLINK_INDEX_BT1              48 // E
#define HS_RGB_BLINK_INDEX_BT2              47 // R
#define HS_RGB_BLINK_INDEX_BT3              46 // T
#define HS_RGB_BLINK_INDEX_2G4              45 // Y
#define HS_RGB_BLINK_INDEX_USB              44 // U
*/
